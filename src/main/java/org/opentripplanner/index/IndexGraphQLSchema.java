...
public class IndexGraphQLSchema {
    ...
    public static GraphQLScalarType unixTimestampSecondsScalar = new GraphQLScalarType("UnixTimestampSeconds", "Unix timestamp in seconds. The value appears in JSON as an integer.", Scalars.GraphQLLong.getCoercing());
    ...
    public IndexGraphQLSchema(GraphIndex index) {
		...
		.description("Stop affected by the disruption")
            ...
            .field(GraphQLFieldDefinition.newFieldDefinition()
                ...
                .type(unixTimestampSecondsScalar)
    ...
    private void createPlanType(GraphIndex index) {
        final GraphQLObjectType placeType = GraphQLObjectType.newObject()
            ...
            .field(GraphQLFieldDefinition.newFieldDefinition()
                ...
                .type(new GraphQLNonNull(unixTimestampMillisecondsScalar))
        ...
        final GraphQLObjectType legType = GraphQLObjectType.newObject()
            ...
            .field(GraphQLFieldDefinition.newFieldDefinition()
                ...
                .type(unixTimestampMillisecondsScalar)
